...
exports.createSkillNodeMap1 = createSkillNodeMap1;
exports.createSkillNodeMap2 = createSkillNodeMap2;
exports.createSkillNodeMap3 = createSkillNodeMap3;
exports.mainSkillNodeMap = mainSkillNodeMap;
function createSkillNodeMap1() {
    const skillNodeMap1 = new Map();
...
function createSkillNodeMap2() {
    const skillNodeMap2 = new Map();
...
function createSkillNodeMap3() {
    const skillNodeMap3 = new Map();
...
function mainSkillNodeMap() {
    const mainSkillNodeMap = new Map();
